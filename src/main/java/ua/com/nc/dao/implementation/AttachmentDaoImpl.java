...
public class AttachmentDaoImpl extends AbstractDaoImpl<Attachment> implements AttachmentDao {
    ...
    protected List<Attachment> parseResultSet(ResultSet rs) throws SQLException {
        ...
        log.debug("received Attachments from database  "  + attachments);
        return attachments;
    }
    ...
    public Attachment getByUrl(String url) throws PersistException {
        ...
        log.debug("Select attachment by url  " + url + " " + sql);
    ...
    public List<Attachment> getByLessonId(Integer lessonId) {
        ...
        log.debug("Select attachment for lesson by lesson id  " + lessonId + " " + sql);
    ...
    public List<Attachment> getByTrainerId(Integer trainerId) {
        ...
        log.debug("Select attachments uploaded by  trainer, trainerId  " + trainerId + " " + sql);
