...
public interface GenericDao<E extends Entity>{
     ...
     * @return the list of all tuples converted into objects of the type of param E
     ...
     * updates all fields of the object in the database
     * @param entity entity whose state will be stored into the tuple int the database with such id
     ...
     * @param entity object of the entity to be inserted must have mo id setted
