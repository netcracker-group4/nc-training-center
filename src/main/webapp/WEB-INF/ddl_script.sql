...
(
    ...
    USER_GROUP_ID INTEGER REFERENCES USR_GROUP (ID) ON DELETE CASCADE
);
...
(
    ID           SERIAL PRIMARY KEY,
    USER_ID      INTEGER REFERENCES USR (ID),
    GROUP_ID     INTEGER REFERENCES GRUP (ID) ON DELETE CASCADE,
...
(
    ID          SERIAL PRIMARY KEY,
    GROUP_ID    INTEGER REFERENCES GRUP (ID) ON DELETE SET NULL,
